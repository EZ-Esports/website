WITH gallery_defaults(src, caption, school_name, event_name, set_id, display_order) AS (
  VALUES
    ...
    ('/images/gallery/gallery-10.png', 'EZ Esports community meetup - student networking', '', 'Community Meetup', 2, 1),
    ('/images/gallery/gallery-11.png', 'Opening ceremony - Fall 2022 season kickoff', '', 'Fall 2022 Kickoff', 2, 2)
)
