...
**Shell layout.** `AdminShell.tsx`: 16rem left sidebar pinned to the viewport (`sticky top-0 h-screen`); its nav list scrolls internally if taller than the viewport, and the Public Site / Sign Out footer is always visible. Page content scrolls the document. No mobile drawer exists.
