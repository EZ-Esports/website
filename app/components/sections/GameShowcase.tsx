    ...
    <Section>
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {games.map((game, index) => {
          ...
          const content = (
            <div
              className="relative aspect-[16/6] w-full rounded-2xl overflow-hidden group cursor-pointer border border-line/80 hover:border-accent/60 shadow-xl shadow-black/20 transition-all duration-300 active:scale-[0.98]"
            >
              <Image
                src={game.imageUrl}
                alt={game.title}
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-surface-sunken/90 via-surface-sunken/40 to-transparent" aria-hidden="true" />
