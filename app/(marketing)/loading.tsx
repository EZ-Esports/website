export default function MarketingLoading() {
  return (
    <div
      className="min-h-[60vh] flex flex-col items-center justify-center gap-6 bg-surface"
      aria-live="polite"
    ...
    >
      ...
      <div className="flex items-end gap-1.5 h-10" aria-hidden="true">
        {[0, 1, 2, 3, 4].map((i) => (
          <div
            key={i}
            className="w-1.5 rounded-full bg-accent/60 animate-pulse motion-reduce:animate-none"
            style={{
              height: `${40 + i * 8}%`,
