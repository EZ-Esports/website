...
export default function TacticalFightTacticsHubPage() {
  const game = GAMES['tactical-fight-tactics'];
  ...
  return (
    <main>
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-gray-800 rounded-lg p-6 text-center">
            <div className="text-3xl font-bold text-rose-300 mb-2">9-6</div>
      ...
      >
        <div className="max-w-2xl mx-auto bg-white rounded-lg p-6 shadow-lg">
          <div className="text-center mb-4">
            ...
            <div className="text-2xl font-bold text-gray-900 mb-4">Stuyvesant vs. Staten Island Tech</div>
            <div className="text-gray-600">Varsity Division</div>
          </div>
          <div className="flex justify-center mt-6">
            <Link href={getGameSubRoute('tactical-fight-tactics', 'schedule')}>
      ...
      >
        ...
        <div className="flex justify-center mt-6">
          <Link href={getGameSubRoute('tactical-fight-tactics', 'standings')}>
      ...
      >
        ...
        <div className="flex justify-center gap-4 mt-6">
          <Link href={getGameSubRoute('tactical-fight-tactics', 'teams')}>
            <Button variant="primary">See All Teams</Button>
          </Link>
          <Link href={getGameSubRoute('tactical-fight-tactics', 'roster')}>
