...
*   **Action & CTA Buttons**: Use [app/components/ui/CutCTA.tsx](file:///Users/shangminchen/website/app/components/ui/CutCTA.tsx) for brand buttons (e.g. "Apply to Play"). It wraps RAC's `Link` and manages diagonal corner clipping along with inset focus rings.
