...
1. **Read-Only / Isolated Worktrees**: Never modify files on `main`. Conduct searches and audit passes either within a dedicated worktree or purely via git inspect commands (`git diff`, `git show`, `gh pr diff`).
